...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("goal", "Set a standing goal Hermes works on across turns until achieved", "Session",
               args_hint="[--interval 5m|self-paced] [--termination judge|bounded] [--require-approval] <text> | approval <owner|automatic> | approve <id> | reject <id> | pause | resume | stop | clear | status | wait <pid> | unwait",
    ...
    CommandDef("loop", "Compatibility alias for scheduled /goal work", "Session",
               aliases=("proactive",),
               args_hint="[interval] <prompt> [--times N] [--until <condition>] | status | pause | resume | stop (prefer /goal --interval)",
